import type { Vehicle, VehicleList, Zone, Anomaly, FleetState } from '../types'

const _vehicles: Vehicle[] = Array.from({ length: 50 }, (_, i) => ({
  vehicle_id: `v-${String(i + 1).padStart(2, '0')}`,
  status: ['idle', 'moving', 'charging', 'fault'][i % 4] as any,
...
export const mockVehicles: Vehicle[] = _vehicles

export const mockVehicleList: VehicleList = {
...
export const mockFleetState: FleetState = {
  counts: {
    idle: 15,
    moving: 20,
    charging: 10,
